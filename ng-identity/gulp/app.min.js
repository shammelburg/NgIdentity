...
var app;!function(t){var o;!function(t){var o=function(){function t(t,o,e,n){this.$scope=t,this.$log=o,this.$state=e,this.accountService=n,this.something=function(){}}return t.prototype.ChangePassword=function(t){var o=this;this.$scope.$broadcast("show-errors-event"),this.$scope.changeForm.$invalid||this.accountService.ChangePassword(t).then(function(t){o.model={},o.message=t.data,o.isSuccess=!0})["catch"](function(t){o.message=t.data.Message})},t.prototype.Somthing=function(){},t.$inject=["$scope","$log","$state","accountService"],t}();angular.module("app").controller("AccountChangeController",o)}(o=t.controllers||(t.controllers={}))}(app||(app={}));
...
var app;!function(t){var o;!function(t){var o=function(){function t(t,o,n){var e=this;this.accountService=t,this.authService=o,this.$timeout=n,this.authService.Check(["Admin"]),this.message="Email not confirmed",this.accountService.UserInfo().then(function(t){e.user=t.data})["catch"](Common.Error.prototype.LogError)}return t.prototype.SendConfirmation=function(){var t=this;this.accountService.SendConfirmationEmail().then(function(){t.message="Email sent",t.$timeout(function(){this.message="Email not confirmed"},5e3)})["catch"](Common.Error.prototype.LogError)},t.$inject=["accountService","authService","$timeout"],t}();angular.module("app").controller("AccountController",o)}(o=t.controllers||(t.controllers={}))}(app||(app={}));
